...
import imageSmoothies from '@/public/images/cards/45. smoothies.jpg';
import imageGingerTea from '@/public/images/cards/46. gingerTea.jpg';
import imageOrangeTea from '@/public/images/cards/47. orangeTea.jpg';
...
export const drinks = [
  ...
  },
  {
    ...
    image: imageSmoothies,
    weight: 250,
    price: 200,
    id: 'smoothies',
    description: 'из хурмы, киви, банана и апельсина',
    type: 'drinks',
    counter: 0,
  },
  {
  ...
  {
    title: 'Апельсиновый чай',
    image: imageOrangeTea,
    weight: 250,
    price: 200,
    id: 'orangeTea',
    description: 'с мятой и базиликом',
    type: 'drinks',
    counter: 0,
  },
  {
